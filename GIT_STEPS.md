# Git/GitHub steps для проекта «Учёт проектов»

```bash
git init
git branch -M main
git add README.md .gitignore main.py projects.json tests/test_app.py
git commit -m "Создать базовую структуру проекта"
git remote add origin https://github.com/pipelineOfProjects1t/code-collaboration-lab.git
