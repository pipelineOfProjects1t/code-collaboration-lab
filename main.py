...
PROJECT_TITLE = 'Учёт проектов'
DATA_FILE = Path(__file__).with_name('projects.json')
FIELDS = [{'name': 'title', 'label': 'Название проекта', 'type': 'text', 'sample': 'Git case'}, {'name': 'description', 'label': 'Описание', 'type': 'text', 'sample': 'Проект по GitHub'}, {'name': 'deadline', 'label': 'Дедлайн', 'type': 'text', 'sample': '2026-06-10'}, {'name': 'status', 'label': 'Статус', 'type': 'choice', 'sample': 'planned', 'choices': ['planned', 'in_progress', 'done']}]
GROUP_FIELD = 'status'
NUMERIC_FIELD = None
NUMERIC_LABEL = ''
NUMERIC_MODE = ''
DUPLICATE_FIELDS = ['title']
SAMPLE_RECORD = {'title': 'Git case', 'description': 'Проект по GitHub', 'deadline': '2026-06-10', 'status': 'planned'}
